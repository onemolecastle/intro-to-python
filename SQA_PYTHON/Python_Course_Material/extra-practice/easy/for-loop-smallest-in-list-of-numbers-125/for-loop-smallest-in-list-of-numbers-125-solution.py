"""
Exercise: Find the Smallest Element in a List of numbers (id=125)
...
Requirements:
Write a Python program that finds the smallest element in a given list of numbers using a for loop.
...
class TestFindSmallestElement(unittest.TestCase):
    ...
    def test_invalid_input_3(self):
        self.assertEqual(find_smallest_element(['ABC', 'ADF','XX']), "Empty list provided as input")
